...
用途：给“下次继续开发时恢复上下文”使用；它们不是对外发布说明，也不是面向第一次使用者的入口。
...
1. `INSTALLER-REFACTOR-ROADMAP-ZH.md`
2. `INSTALLER-NEXT-STAGE-BACKLOG-ZH.md`
3. `INSTALLER-CONTROL-PLANE-HANDOFF-2026-04-29-ZH.md`
4. `INSTALLER-INSPECTION-FIRST-HANDOFF-2026-04-22-ZH.md`
5. `INSTALLER-STATE-MODEL-ZH.md`
6. `INSTALLER-RESULT-CONTRACTS-ZH.md`
7. `INSTALLER-PAUSE-HANDOFF-2026-04-21-ZH.md`
