...
用途：给“下次继续开发时恢复上下文”使用；它不是对外发布说明，也不是面向第一次使用者的入口。
...
3. `INSTALLER-STATE-MODEL-ZH.md`
4. `INSTALLER-RESULT-CONTRACTS-ZH.md`
5. `INSTALLER-PAUSE-HANDOFF-2026-04-21-ZH.md`
